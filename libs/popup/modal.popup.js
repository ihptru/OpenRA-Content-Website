function modalPopup(align, top, width, padding, disableColor, disableOpacity, backgroundColor, borderColor, borderWeight, borderRadius, fadeOutTime, url, loadingImage, TextColor){
	...
	document.getElementById('outerModalPopupDiv').style.color = TextColor;
...
function pageloader(page_request, containerid, loadingImage){
	...
	if (page_request.readyState == 4 && (page_request.status==200 || window.location.href.indexOf("http")==-1)) {
		document.getElementById(containerid).innerHTML="<div style='text-align:left;font-family:Monospace;'><pre>"+page_request.responseText+"</pre></div>";
	}
