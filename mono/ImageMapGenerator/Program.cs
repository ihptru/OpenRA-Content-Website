...
namespace ImageMapGenerator
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Stage0");
            string filename = "";
            OptionSet o = new OptionSet()
                .Add("filename=|f=", v => filename = v);
            o.Parse(args);
            Console.WriteLine("filename: " + filename);
            string output = Path.GetDirectoryName(filename) + System.IO.Path.DirectorySeparatorChar + "fullPreview.bmp";
            ...
            if(filename != "" && System.IO.File.Exists(filename))
            {
                ...
                Console.WriteLine("Stage13");
                e.Dispose();
                full.Save(output);
                Console.WriteLine("Stage14");
            }
        }
